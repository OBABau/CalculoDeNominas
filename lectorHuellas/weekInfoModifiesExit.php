...
<body>
  ...
  <div class="loginBody">                
    <form class="login-form" method="POST" action="weekInfoPExit.php">
        <label class="lblinput" for="monday">Lunes:</label>
        <input type="time" id="monday" name="monday" value="<?php echo $mondayExit; ?>" >
    
        <label class="lblinput" for="tuesday">Martes:</label>
        <input type="time" id="tuesday" name="tuesday" value="<?php echo $tuesdayExit; ?>" >
        
        <label class="lblinput" for="wednesday">Miercoles:</label>
        <input type="time" id="wednesday" name="wednesday" value="<?php echo $wednesdayExit; ?>" >

        <label class="lblinput" for="thursday">Jueves:</label>
        <input type="time" id="thursday" name="thursday" value="<?php echo $thursdayExit; ?>" >

        <label class="lblinput" for="friday">Viernes:</label>
        <input type="time" id="friday" name="friday" value="<?php echo $fridayExit; ?>" >

        <label class="lblinput" for="saturday">Sabado:</label>
        <input type="time" id="saturday" name="saturday" value="<?php echo $saturdayExit; ?>" >

        <label class="lblinput" for="sunday">Domingo:</label>
        <input type="time" id="sunday" name="sunday" value="<?php echo $sundayExit; ?>" >
