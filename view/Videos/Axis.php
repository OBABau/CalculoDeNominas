...
<body>
    <header class="nav-bar">
        <div class="navbarVideos">
            <a href="../../iniciado.php" class="active">TFT</a>
        </div>
    ...
    <div class="buscar">
        <form action="Axis.php" method="POST">
    ...
    <div class="Videos">
        ...
        $link = "https://www.googleapis.com/youtube/v3/search?key=".$key."&channelId=UCjhF85rfM55_kdB7amjZaVw&part=snippet,id&order=date&maxResults=".$contenido."";
        $json = file_get_contents($link);
        $array = json_decode($json, true);
        foreach($array['items'] as $element){
            echo '<div class="box">';
            if(isset($element['id']['videoId'])){
                ...
                echo "No hay más videos para mostrar.";
            }
            echo '</div>';
        }
        ?>
