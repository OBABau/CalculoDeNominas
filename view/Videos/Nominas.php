...
<body>
    <header class="nav-bar">
        <div class="navbarVideos"><a href="../../iniciado.php" class="active">TFT</a></div>
    ...
    <div class="Videos">
        ...
        $link = "https://www.googleapis.com/youtube/v3/search?key=".$key."&channelId=UClbAkP5DLsq2dzHMzUL75Pg&part=snippet,id&order=date&maxResults=".$contenido."";
