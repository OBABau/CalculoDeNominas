        ...
        <div class="login-container4">
            ...
            <div class="loginBody">
                <form class="login-form" method="post" action="addPayment.php">
                    <div class="formRow">
                        <label class="lblinput" for="name">Name:</label>
                        <i class="fa fa-user"></i>
                        <input class="input" type="text" id="name" name="name" maxlength="50"
                            placeholder="Ingrese nombre" required>
                    </div>
                    <div class="formRow">
                        <label class="lblinput" for="cardNumber">Card Number (16 digits):</label>
                        <i class="fa fa-key"></i>
                    ...
                    <div class="formRow">
                        <label class="lblinput" for="cvv">CVV (3 digits):</label>
                        <i class="fa fa-key"></i>
                        <input class="input" type="text" id="cvv" name="cvv"pattern="\d{3}" title="Ingresa 3 digitos" minlength="3" maxlength="3" required>
                    </div>          
                    <div class="formRow">
                        <label class="lblinput" for="expirationDate">Expiration Date (MM/YY):</label>
                        <i class="fa fa-key"></i>
