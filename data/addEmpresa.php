...
if ($tupla['total'] > 0) {
    ...
    header("Location: ../view/registrarEmpresas.php?error=email_en_uso");
    exit();
}
...
if ($_POST['contrasena'] === $_POST['confirmar_contrasena']) {
    ...
    header("Location: ../view/registrarEmpresas2.php");
    exit();
} else {
    // Las contraseñas no coinciden, redirigir al usuario de vuelta al formulario con un mensaje de error
    header("Location: ../view/registrarEmpresas.php?error=contrasena");
    exit();
}
?>
